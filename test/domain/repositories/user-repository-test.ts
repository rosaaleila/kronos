...
describe("User Repository", () => {
    ...
    describe("getAllUsers", () => {
        test("should return data", async () => {
            const expectedData = [{ id: '1', email: 'test@test.com', first_name: "Test", created_at: '2000-01-01T02:00:00.000+00:00', updated_at: '2000-01-01T02:00:00.000+00:00' }];
    ...
    describe("createUser", () => {
        test("should return true", async () => {
            const inputData = { email: 'test@test.com', first_name: "Test" };
